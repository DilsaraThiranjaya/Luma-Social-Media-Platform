$(document).ready(function () {
  ...
  const bgMusic = new Audio("/games/assets/audio/Bg-music.mp3");
  ...
  bgMusic
    ...
    .catch(() => {
      $("#sound-btn img").attr(
        "src",
        "/games/assets/images/UI/SoundOff/Default@2x.png"
      );
      bgMusic.volume = 0.5;
      bgMusic.pause();
    });
  ...
  soundBtn.hover(
    function () {
      ...
      if (bgMusic.paused) {
        $("#sound-btn img").attr(
          "src",
          "/games/assets/images/UI/SoundOff/Hover@2x.png"
        );
      } else {
        $("#sound-btn img").attr(
          "src",
          "/games/assets/images/UI/SoundOn/Hover@2x.png"
        );
      }
    },
    function () {
      ...
      if (bgMusic.paused) {
        ...
        $("#sound-btn img").attr(
          "src",
          "/games/assets/images/UI/SoundOn/Default@2x.png"
        );
      }
    }
  );
  ...
  pauseBtn.hover(
    function () {
      // Mouse enter
      if (gameRunning) {
        $("#pause-btn img").attr("src", "/games/assets/images/UI/Pause/Hover@2x.png");
      } else {
        $("#pause-btn img").attr("src", "/games/assets/images/UI/Play/Hover@2x.png");
      }
    },
    function () {
      // Mouse leave
      if (gameRunning) {
        $("#pause-btn img").attr(
          "src",
          "/games/assets/images/UI/Pause/Default@2x.png"
        );
      } else {
        $("#pause-btn img").attr(
          "src",
          "/games/assets/images/UI/Play/Default@2x.png"
        );
      }
    }
  );
  ...
  repeatBtn.hover(
    function () {
      // Mouse enter
      $("#repeat-btn img").attr("src", "/games/assets/images/UI/Repeat/Hover@2x.png");
    },
    function () {
      // Mouse leave
      $("#repeat-btn img").attr(
        "src",
        "/games/assets/images/UI/Repeat/Default@2x.png"
      );
    }
  );
  ...
  introPlayBtn.hover(
    function () {
      ...
      $("#intro-play-btn img").attr(
        "src",
        "/games/assets/images/UI/PlayText/Hover@2x.png"
      );
    },
    function () {
      // Mouse leave
      $("#intro-play-btn img").attr(
        "src",
        "/games/assets/images/UI/PlayText/Default@2x.png"
      );
    }
  );
    ...
    function () {
      ...
      if (!$(this).hasClass("active")) {
        if ($(this).val() <= unlockedLevels) {
          $(this)
            .find("img")
            .attr("src", "/games/assets/images/UI/Levels/Unlocked/Hover@2x.png");
        } else {
          $(this)
            .find("img")
            .attr("src", "/games/assets/images/UI/Levels/Locked/Hover@2x.png");
        }
      }
    },
    function () {
      ...
      if (!$(this).hasClass("active")) {
        if ($(this).val() <= unlockedLevels) {
          $(this)
            .find("img")
            .attr("src", "/games/assets/images/UI/Levels/Unlocked/Default@2x.png");
        } else {
          $(this)
            .find("img")
            .attr("src", "/games/assets/images/UI/Levels/Locked/Default@2x.png");
        }
      }
    }
  );
  ...
  pauseBtn.click(function () {
    if (gameRunning) {
      ...
      gameRunning = false;
      $("#pause-btn img").attr("src", "/games/assets/images/UI/Play/Default@2x.png");
    } else {
      ...
      gameRunning = true;
      $("#pause-btn img").attr("src", "/games/assets/images/UI/Pause/Default@2x.png");
    }
  });
    ...
    switch (unlockedLevels) {
      case 1:
        $("#level-1-btn img").attr(
          "src",
          "/games/assets/images/UI/Levels/Unlocked/Hover@2x.png"
        );
        $("#level-2-btn img").attr(
          "src",
          "/games/assets/images/UI/Levels/Locked/Default@2x.png"
        );
      ...
      case 2:
        ...
        $("#level-2-btn img").attr(
          "src",
          "/games/assets/images/UI/Levels/Unlocked/Default@2x.png"
        );
